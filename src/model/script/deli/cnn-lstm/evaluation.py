...
def plot_results(labels, preds, r2, history=None, metrics=None):
    ...
    fig.suptitle('Dashboard Evaluasi Model DELI HIBRIDA CNN-LSTM', fontsize=18, weight='bold')
    ...
    plt.savefig('dashboard_evaluasi_deli_cnn_lstm.png', dpi=300)
    print("\n[+] Dashboard Evaluasi berhasil disimpan ke 'dashboard_evaluasi_deli_cnn_lstm.png'")