...
from model import build_transformer, R2Callback
from evaluation import evaluate_detailed, plot_results

def main():
    print("="*60)
    print("MENGJALANKAN PIPELINE PREDIKSI PM2.5 (TRANSFORMER)")
    print("="*60)
    print("KONFIGURASI EKSPERIMEN TULT (TRANSFORMER)")
    print("> Lokasi Data   : Gedung TULT")
    print("> Horizon       : 1 Jam Ke Depan")
    print("> Input Width   : 24 Jam")
    print("> Label Width   : 1 Jam")
    print("> Model         : Time-Series Transformer")
    ...
    print("[3/5] Membangun model Transformer...")
    model = build_transformer(24, len(FEATURE_COLS))
